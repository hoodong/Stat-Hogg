...
- Chi-square 분포에서 자유도의 의미는?
- Gamma 분포와 Poisson 분포의 관계를 쉽게 설명하면?
- Gamma 분포와 Beta 분포의 관계를 쉽게 설명하면?
- t 분포와 F 분포에서 자유도의 의미는?
- t 분포가 정규분포의 샘플링에서 얻어질 때 분자의 정규분포와 분모의 카이-제곱 분포가 독립이 되는 이유는?  
